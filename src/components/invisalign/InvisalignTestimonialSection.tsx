export default function InvisalignTestimonialSection() {
  return (
      ...
      <div className="mx-auto w-full max-w-[1180px]">
        <div className="mx-auto max-w-[960px] text-center">
          ...
          <div className="mt-9 inline-flex items-center gap-3">
            <span className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-[#C9A961] text-[15px] font-semibold text-[#162033]">
              M
            </span>
            <div className="text-left">
              <p className="text-[16px] font-semibold text-[#111827]">Melissa T.</p>
              <p className="text-[13px] text-[#6E788B]">14-month Invisalign • Calabasas</p>
            </div>
          </div>
        </div>
      </div>
