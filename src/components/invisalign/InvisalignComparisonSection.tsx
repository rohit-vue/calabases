      ...
      <div className="mx-auto w-full max-w-[1180px]">
        <div className="max-w-[820px]">
          <div className="flex items-center gap-3">
            ...
            <p className="text-[11px] font-semibold uppercase tracking-[0.24em] text-[#B87333]">The comparison</p>
          </div>
          ...
          <h2 className="mt-4 font-fraunces text-[34px] font-light leading-[0.92] tracking-tighter text-[#EEF2F8] sm:text-[48px] md:text-[58px] lg:text-[65px]">
            Invisalign vs. <span className="font-light italic text-[#B87333]">traditional braces.</span>
          </h2>
        ...
        <div className="mt-10 grid grid-cols-1 gap-6 lg:grid-cols-[minmax(0,1fr)_84px_minmax(0,1fr)] lg:items-stretch">
          <article className="flex h-full flex-col rounded-[16px] border border-[#B87333] bg-[linear-gradient(160deg,#0A1327_0%,#091224_100%)] px-5 py-6 sm:px-7">
            <header className="min-h-[108px] sm:min-h-[118px]">
              <p className="text-[11px] font-semibold uppercase tracking-[0.22em] text-[#B87333]">Recommended</p>
              <h3 className="mt-3 font-fraunces text-[32px] font-light italic leading-none text-[#B87333] sm:text-[42px] md:text-[49px] lg:text-[36px]">
                Invisalign
              </h3>
            </header>
            <div className="mt-5 border-t border-[#27324A]">
              {comparisonRows.map((row) => (
                ...
                >
                  ...
                  <p className="shrink-0 text-right font-fraunces text-[15px] font-light leading-none text-[#B87333] sm:text-[20px] lg:text-[15px]">
                    {row.invisalign}
                  </p>
                </div>
              ))}
          ...
          <div
            ...
            aria-hidden
          >
            <span className="inline-flex h-[58px] w-[58px] items-center justify-center rounded-full bg-white font-fraunces text-[26px] italic text-[#0A0E1A]">
              vs.
            </span>
          </div>
