      ...
      <div className="mx-auto w-full max-w-[1180px]">
        <div className="max-w-[820px]">
          <div className="flex items-center gap-3">
            ...
            <p className="text-[12px] font-semibold uppercase tracking-[0.24em] text-[#C9A961]">The comparison</p>
          </div>

          <h2 className="mt-4 font-fraunces text-[42px] font-light leading-[0.92] tracking-tighter text-[#EEF2F8] sm:text-[58px] lg:text-[65px]">
            Invisalign vs. <span className="font-light italic text-[#C9A961]">traditional braces.</span>
          </h2>

          <p className="mt-5 max-w-[740px] text-[17px] font-light leading-normal text-[#8E98AC] sm:text-[20px] lg:text-[19px]">
        ...
        <div className="mt-10 grid grid-cols-1 gap-6 lg:grid-cols-[minmax(0,1fr)_84px_minmax(0,1fr)] lg:items-stretch">
          <article className="flex h-full flex-col rounded-[16px] border border-[#9E7A3A] bg-[linear-gradient(160deg,#0A1327_0%,#091224_100%)] px-5 py-6 sm:px-7">
            <header className="min-h-[108px] sm:min-h-[118px]">
              ...
              <h3 className="mt-3 font-fraunces text-[42px] font-light italic leading-none text-[#C9A961] sm:text-[49px] lg:text-[36px]">
                Invisalign
              </h3>
            </header>
            <div className="mt-5 border-t border-[#27324A]">
              {comparisonRows.map((row) => (
                ...
                >
                  ...
                  <p className="shrink-0 text-right font-fraunces text-[18px] font-light leading-none text-[#C9A961] sm:text-[20px] lg:text-[15px]">
                    {row.invisalign}
                  </p>
                </div>
              ))}
          ...
          <article className="flex h-full flex-col rounded-[16px] border border-[#1A2742] bg-[linear-gradient(160deg,#0A1327_0%,#091224_100%)] px-5 py-6 sm:px-7">
            <header className="min-h-[108px] sm:min-h-[118px]">
              ...
              <h3 className="mt-3 font-fraunces text-[42px] font-light leading-none text-[#EEF2F8] sm:text-[49px] lg:text-[36px]">
                Metal Braces
              </h3>
            </header>
            <div className="mt-5 border-t border-[#27324A]">
