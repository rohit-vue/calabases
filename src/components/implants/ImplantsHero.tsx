    ...
    <section className="bg-[#F4F3EB] px-4 py-10 sm:px-8 sm:py-14 lg:px-24 lg:py-16">
      <div className="mx-auto grid w-full max-w-[1180px] grid-cols-1 items-center gap-10 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] lg:gap-14">
        <div className="max-w-[520px]">
          <p className="font-jetbrains text-[9px] uppercase tracking-[0.22em] text-[#C9A961]">
          ...
          <h1 className="mt-6 font-fraunces text-[48px] font-light leading-[0.88] tracking-[-0.05em] text-[#101624] sm:text-[66px] lg:text-[84px]">
            Built to <span className="font-light italic text-[#C9A961]">last</span>
            <br />
            a lifetime.
          </h1>

          <p className="mt-5 max-w-[500px] font-fraunces text-[22px] leading-[1.15] tracking-[-0.01em] sm:text-[29px] lg:text-[22px]">
            <span className="text-[#0A0E1A]">120 million Americans</span>
            <span className="text-[#000000D9] font-light italic text-[20px]"> are missing at least one tooth.</span>
            <br />
            <span className="text-[#000000D9] font-light italic text-[20px]">
              Dental implants are the only solution that doesn&apos;t get worse over time.
            </span>
          </p>

          <p className="mt-6 max-w-[500px] font-sans text-[15px] font-normal leading-[1.6] text-[#0A0E1A99]">
          ...
          <div className="mt-10 grid grid-cols-4 gap-x-10 pt-5 sm:gap-x-12 lg:gap-x-14">
            {stats.map((stat) => (
              <div key={stat.label} className="min-w-0">
                <p className="font-jetbrains text-[9px] uppercase tracking-[0.2em] text-[#C9A961]">{stat.label}</p>
                <p className="mt-2 whitespace-nowrap font-fraunces text-[18px] leading-none text-[#0A0E1A] sm:text-[22px] lg:text-[26px]">
                  {stat.value}
                </p>
              </div>
            ))}
