  ...
  return (
    <section className="overflow-hidden bg-[#D81F36]">
      <div className="px-4 py-14 sm:px-8 sm:py-16 lg:px-20 lg:py-20">
        <div className="mx-auto w-full max-w-[1250px] text-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-[#E84A5D] bg-[#E22A43] px-4 py-1.5">
            ...
            <p className="text-[10px] font-semibold uppercase tracking-[0.18em] text-[#FFE8EC]">
          ...
          <p className="mx-auto mt-5 max-w-[740px] text-[18px] leading-[1.45] text-[#FBD4DA] sm:text-[24px] lg:text-[33px]">
          ...
          <Link
            ...
            className="mt-8 inline-flex h-[62px] items-center rounded-full bg-white px-8 font-fraunces text-[32px] text-[#E0354A] transition hover:opacity-95 sm:h-[68px] sm:px-10 sm:text-[42px] lg:h-[72px] lg:px-12 lg:text-[53px]"
          >
      ...
      <div className="border-t border-[#102036] bg-[#030A1B] px-4 py-4 sm:px-8 lg:px-20">
        <p className="mx-auto w-full max-w-[1250px] text-center text-[11px] text-[#6B7588]">
