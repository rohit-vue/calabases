    ...
    <section className="bg-[linear-gradient(106.66deg,#F5EDD8_0%,#EDE2C2_100%)] px-4 py-14 sm:px-8 sm:py-16 lg:px-24 lg:py-20">
      <div className="mx-auto grid w-full max-w-[1180px] grid-cols-1 items-center gap-10 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] lg:gap-12">
        <div className="min-w-0 max-w-[470px]">
          ...
          <p className="mt-6 max-w-[460px] text-[15px] leading-[1.62] text-[#1C2333]">{body}</p>
        </div>

        <div className="min-w-0 overflow-hidden rounded-[10px] border border-[#E4E0D6] bg-[#F8F8F7] shadow-[0_8px_24px_rgba(0,0,0,0.08)]">
          <div className="grid w-full min-w-0 grid-cols-4 gap-x-1 bg-[#FAF8F3] px-3 py-3 text-[9px] font-semibold uppercase tracking-[0.12em] text-[#5A6578] sm:gap-x-2 sm:px-4 sm:text-[10px] sm:tracking-[0.16em] lg:px-5">
          ...
          <div>
            {rows.map((row) => (
              ...
              >
                <p className="min-w-0 text-[14px] font-inter font-semibold leading-snug text-[#0A0E1A] sm:text-[14px]">
                  {row.treatment}
                </p>
                <p className="min-w-0 text-center text-[14px] leading-tight text-[#5A6578] line-through sm:text-[14px]">
                  {row.standard}
                </p>
                <p className="min-w-0 text-center text-[14px] font-semibold leading-tight text-[#B87333] sm:text-[14px]">
                  {row.gleam}
                </p>
                <p className="min-w-0 text-center text-[14px] font-semibold leading-tight text-[#FF6B35] sm:text-[14px]">
                  {row.save}
                </p>
              </div>
            ))}
